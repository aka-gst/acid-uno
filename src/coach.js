...
const AcidCoach = (() => {
  ...
  */
  const STEPS = [
    ...
    {
      /*
        «Перетащи», а не «положи»: тапом карта не играется,
        играет только перетаскивание. Прежний текст просил
        того, чего в игре нет, — человек тапал, игра молчала,
        и обучение выглядело сломанным. Проверено парой в
        трёх партиях на одной и той же карте.
      */
      target: "hand",
      text: "ХОДИ ЕЩЁ РАЗ.",
      ждём: "любое",
      просьба: "ПЕРЕТАЩИ КАРТУ В ЦЕНТР ИЛИ НАЖМИ КОЛОДУ",
      готово: "ВОТ И ВСЁ",
      светНаГотово: "hand"
    },
    {
